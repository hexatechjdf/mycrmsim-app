            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        <!--begin::Form-->
                        <form class="form w-100" method="POST" action="{{ route('password.store') }}" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="{{ route("login") }}">
                            @csrf
                            ...
                            <!--begin::Heading-->
                            <!--begin::Input group-->
                            <input type="hidden" id="email" hidden name="email" value="{{old('email', $request->email)}}" required>
